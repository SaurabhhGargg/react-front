...
class SignUp extends Component {
  ...
  validate = () => {
    ...
    else if (!this.state.email.match("^([a-zA-Z0-9\.-]+)@([a-zA-Z0-9-]+).([a-z]{2,8})(.[a-z]{2,8})$")) {
      EmailError = "Enter the correct email "
    }  
    ...
    else if (!this.state.mobileNumber.match("^[0-9]{10}")) {
    ...
    if (NameError || passwordError || EmailError || MobileNumberError || Address1Error || CityError || StatesError || ZipError) {
      this.setState({ NameError, EmailError, passwordError, MobileNumberError, Address1Error, CityError, StatesError, ZipError })
      return false
    }
    return true
  }
  ...
  stopSubmission = (e) => {
    ...
    if (!this.state.NameError && !this.state.passwordError && !this.state.EmailError && !this.state.MobileNumberError && !this.state.Address1Error  && !this.state.ZipError) {
      axios
            ...
            <div className="card col-md-6 offset-md-3 offset-md-3 p-4" style={{ borderRadius: "10px", boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)" }}>
              ...
              <div className="card-body">
                <form method="POST" onSubmit={this.stopSubmission} >
                  ...
                  <br></br>
                  <div>
                    <label className="font-weight-bold" title="MobileNumberError">Mobile Number</label>
                    <input
                      name="Mobile Number"
                      title="number"
                      type="Number"
                  ...
                  <div>
                    <label className="font-weight-bold">Address1</label>
                    <input
                      name="Address1"
                      type="text"
                      className="form-control"
                  ...
                  <div>
                    <label className="font-weight-bold">Address2</label>
                    <input
                      name="Address2"
                      type="text"
                      className="form-control"
                  ...
                  <div className="text-center pd-4 " style={{ marginBottom: "10px" }} >
                    <button className="btn btn-outline-success mr-3" title ="sign">Submit</button>{"  "}
                    <Link to="/"><button className="btn btn-outline-secondary">Sign In Now</button></Link>
                  </div>
                </form>
              </div>
            </div>
